        ...
        REGISTER_WINDOW_CLASS.call_once(|| {
            {
                ...
                let result = unsafe {
                    GetClassInfoW(Some(instance.into()), WINDOW_CLASS, class.as_mut_ptr())
                };
                if result.is_ok() {
                    return;
                }
