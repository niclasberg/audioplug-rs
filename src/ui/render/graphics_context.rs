use thiserror::Error;
use wgpu::{DeviceDescriptor, RequestAdapterOptionsBase};

use crate::{core::Size, platform};
...
impl<'a> GraphicsContext<'a> {
    pub(crate) async fn new(handle: &'a platform::Handle) -> Result<Self, GraphicsInitError> {
